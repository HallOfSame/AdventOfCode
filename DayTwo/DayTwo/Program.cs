...
namespace DayTwo
{
    internal class Program
    {
        ...
        #region Nested type: PasswordInput
        ...
        private class PasswordInput
        {
            ...
            public PasswordInput(string inputText)
            {
                ...
                MinOccur = int.Parse(min);

                MaxOccur = int.Parse(max);

                RestrictedChar = chr[0];
            ...
            public bool IsValid
            {
                get
                {
                    var occurrencesOfChar = Password.ToCharArray()
                                                    .Count(x => x == RestrictedChar);

                    return occurrencesOfChar >= MinOccur && occurrencesOfChar <= MaxOccur;
                }
            }

            private int MaxOccur { get; }

            private int MinOccur { get; }
